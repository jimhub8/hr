...
<v-layout row justify-center>
    <v-dialog v-model="dialog" persistent max-width="500px">
        <v-card>
            <v-card-title>
                <span class="headline text-center" style="margin: auto;">Edit Department</span>
            </v-card-title>
            <v-divider></v-divider>
            <v-card-text>
                        ...
                        <v-flex sm12>
                            <v-card-text>
                                <div>
                                    ...
                                    <el-input placeholder="Department" v-model="form.name"></el-input>
                                </div>
                                <div>
...
export default {
    ...
    created() {
        eventBus.$on("openEditDepartment", data => {
            this.form = data
            this.dialog = true;
        });
    },
