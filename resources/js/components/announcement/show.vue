...
<v-layout row justify-center>
    <v-dialog v-model="dialog" persistent max-width="500px">
        <v-card>
            <v-card-title>
                <span class="headline text-center" style="margin: auto;">Announcement Details</span>
                <VSpacer />
            ...
            <v-card-actions>
                <v-btn text v-show="disapproved" color="primary">Submit</v-btn>
...
export default {
    ...
    created() {
        eventBus.$on("openShowAnnouncement", data => {
            this.dialog = true;
            this.form = data;
        });
    },
