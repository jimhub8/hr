...
<v-layout row justify-center>
    <v-dialog v-model="dialog" persistent max-width="500px">
        <v-card>
            <v-card-title>
                <span class="headline text-center" style="margin: auto;">Edit Promotion</span>
            </v-card-title>
            <v-divider></v-divider>
            <v-card-text>
                        ...
                        <v-flex sm12>
                            <v-card-text>
                                <div>
                                    ...
                                    <el-input placeholder="Promotion" v-model="form.name"></el-input>
                                </div>
                                <div>
...
export default {
    ...
    created() {
        eventBus.$on("openEditPromotion", data => {
            this.form = data
            this.dialog = true;
        });
    },
