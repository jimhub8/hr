...
<v-layout row justify-center>
    <v-dialog v-model="dialog" persistent max-width="500px">
        <v-card>
            <v-card-title>
                <span class="headline text-center" style="margin: auto;"> PROFESSIONAL EXPERIENCE</span>
            </v-card-title>
            <v-divider></v-divider>
            <v-card-text>
                        ...
                        <v-flex sm12>
                            <v-card-text>
                                ...
                                <div>
                                    ...
                                    <el-date-picker v-model="form.passing_year" type="year" placeholder="Pick a year" style="width: 100%;">
                                    </el-date-picker>
                                </div>
                            </v-card-text>
                        </v-flex>
...
export default {
    ...
    created() {
        eventBus.$on("expirienceEvent", data => {
            this.dialog = true;
        });
    },
